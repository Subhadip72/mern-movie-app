...
const SingleMovie = () => {
  ...
  return (
    <main>
      ...
      >
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="flex items-center gap-4">
            <p className="text-white">{movieDetails?.vote_average}</p>
          ...
          <p className="text-white lg:text-xl">{movieDetails?.overview}</p>
          <div className="text-white flex gap-10 items-center">
            <button
              type="button"
              className={btnClassName}
              onClick={() => {
                if (favorite?.movieName === movieDetails?.original_title) {
      ...
      <Backdrops movieImg={movieImg} />
      <Posters data={movieImg} />
      <Reviews movieDetails={movieDetails && movieDetails} />
